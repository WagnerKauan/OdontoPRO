...
export function ServiceList({ services, permission }: ServiceListProps) {
  ...
  async function handleDeleteService(service: string) {
    const response = await deleteService({ serviceId: service });
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {permission.hasPermission ? (
              ...
              <Link
                ...
                className="inline-block bg-blue-600 text-white px-4 py-2 rounded-lg font-medium shadow hover:bg-blue-700 hover:shadow-md transition-all"
              >
